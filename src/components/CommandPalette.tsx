    ...
    <div className="fixed inset-0 z-50 flex items-start justify-center pt-[20vh]">
      ...
      <div className="relative w-full max-w-2xl bg-zinc-900/95 backdrop-blur-xl border border-zinc-700/50 rounded-2xl shadow-2xl shadow-black/50 overflow-hidden animate-scale-in">
          ...
          {isSupported && (
            <button
              ...
              className={`p-2 rounded-lg transition-colors ${
                isListening ? 'bg-red-500/15 text-red-400' : 'hover:bg-zinc-800 text-zinc-500'
              }`}
        ...
        {(streamText || result) && !executedOps.length && (
          <div className="px-5 py-3 text-sm text-zinc-300 border-t border-zinc-800/60 bg-zinc-950/30 max-h-48 overflow-y-auto">
        ...
        <div className="px-5 py-2.5 bg-zinc-950/40 text-[11px] text-zinc-600">
